...
internal sealed class EvalCommand<TResult> : Command<TResult>
{
    ...
    private static readonly RedisValueObject[] EmptyArgs = [];
    ...
    {
        return new EvalCommand<TResult>(script, isSHA, keys, [arg.ToValue()]);
    }

    public static EvalCommand<TResult> Create<T1, T2>(string script, bool isSHA, T1 arg1, T2 arg2, string[] keys)
    {
        return new EvalCommand<TResult>(script, isSHA, keys, [arg1.ToValue(), arg2.ToValue()]);
    }

    public static EvalCommand<TResult> Create<T1, T2, T3>(string script, bool isSHA, T1 arg1, T2 arg2, T3 arg3, string[] keys)
    {
        return new EvalCommand<TResult>(script, isSHA, keys, [arg1.ToValue(), arg2.ToValue(), arg3.ToValue()]);
    }
}